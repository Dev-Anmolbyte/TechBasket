...
const TermsAndConditions = () => (
  <Container className="py-5" style={{ maxWidth: 800 }}>
    <h1 className="mb-4 text-center text-primary fw-bold">
      TechBasket Terms & Conditions
    </h1>
    <p className="text-muted text-center mb-5">Effective Date: 24 July 2025</p>

    <h4>1. Acceptance of Terms</h4>
    <p>
      By accessing or using the TechBasket website ("Site") and services, you
    ...
    <ul>
      <li>
        We strive to ensure that all product details and prices are accurate,
    ...
    <ul>
      <li>
        Shipping times are estimates only. TechBasket is not responsible for
        delivery delays beyond our control.
      </li>
      <li>
        Risk of loss and title for purchased items pass to you upon delivery to
        the carrier.
      </li>
    </ul>
    ...
    <ul>
      <li>
        Please review our Return Policy for detailed information on returns and
        refunds.
      </li>
      <li>
        Products must be returned unused and in original packaging within 7 days
    ...
    <ul>
      <li>
        No unlawful, fraudulent, or abusive activity is permitted on this Site.
      </li>
      <li>
        You must not attempt to harm or disrupt our operations or security.
      </li>
    </ul>
    ...
    <ul>
      <li>
        All content, design, text, graphics, logos, images, and software are the
        property of TechBasket or its licensors, protected by relevant
        intellectual property laws.
      </li>
      <li>
        No material from this Site may be copied, reproduced, republished,
        uploaded, or distributed without prior written consent.
      </li>
    </ul>

    <h4>9. Limitation of Liability</h4>
    <p>
      TechBasket shall not be liable for any indirect, incidental,
    ...
    <p>
      ...
      Continued use of the Site implies acceptance of the revised terms.
    </p>

    <h4>11. Governing Law</h4>
    <p>
      These Terms shall be governed according to the laws of [Your
      Country/State]. All disputes shall be subject to the exclusive
      jurisdiction of the courts at [Your Jurisdiction].
    </p>
